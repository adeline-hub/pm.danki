...
path('password_reset_complete/', auth_views.PasswordResetCompleteView.as_view(template_name='users/passwordreset-complete.html'), name = 'password_reset_complete'),
